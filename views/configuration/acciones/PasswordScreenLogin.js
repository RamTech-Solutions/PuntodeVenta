...
export default function PasswordScreenLogin({ navigation }) {
    ...
    return (
        <SafeAreaView className="flex-1 justify-between gap-10 bg-white">
            <View className="mx-5 justify-between flex-1">
                ...
                <View className="gap-5">
                    ...
                    <Text className="text-3xl font-bold">¿Olvidaste tu contraseña?</Text>
